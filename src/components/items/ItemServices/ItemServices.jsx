...
function ItemServices({ id, name, price, img }) {//mostrar caracteristicas de los servicios
    return (//asignando estilos y redirigiendo al itemdetail
        <div className="flex flex-col items-center mx-4 my-6 p-4 bg-[#f0f0f0] rounded-lg shadow-lg hover:scale-105 transition-transform duration-300 max-w-xs sm:max-w-sm">
            <img src={img} alt="Imagen del Servicio" className="w-32 h-32 sm:w-36 rounded-full" />
